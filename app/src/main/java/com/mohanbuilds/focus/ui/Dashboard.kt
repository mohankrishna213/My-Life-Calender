...
import com.mohanbuilds.focus.domain.Intensity
import com.mohanbuilds.focus.domain.calculateGridSpec
import com.mohanbuilds.focus.domain.color
import com.mohanbuilds.focus.domain.datesBetween
import com.mohanbuilds.focus.domain.daysRemaining
import com.mohanbuilds.focus.domain.summarizeByDate
...
fun Dashboard(
    ...
    val startEnd = remember(goal) {
        val s = runCatching { LocalDate.parse(goal.startDate) }.getOrNull() ?: LocalDate.now()
        val e = runCatching { LocalDate.parse(goal.endDate) }.getOrNull() ?: s
        s to e
    }
